...
def main():
    ...
    trainer.train()
    trainer.evaluate()
    trainer.save_model("pretrained_mnli/best_model")
    tokenizer.save_pretrained("pretrained_mnli/best_model")


    model_checkpoint = f"pretrained_mnli/best_model"
    ...
    trainer.train()
    trainer.evaluate()
    trainer.save_model("pretrained_mnli_rte/best_model")
    tokenizer.save_pretrained("pretrained_mnli_rte/best_model")

    model_checkpoint = f"pretrained_mnli_rte/best_model"
    ...
    trainer.train()
    trainer.evaluate()
    trainer.save_model("pretrained_mnli_rte_fever/best_model")
    tokenizer.save_pretrained("pretrained_mnli_rte_fever/best_model")
