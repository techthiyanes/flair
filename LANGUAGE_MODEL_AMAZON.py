...
def train(model_checkpoint, samples, run):
    ...
    train_texts, train_labels = read_csv('../.flair/datasets/amazon_review_full_csv/train.csv', samples=samples)
    train_encodings = tokenizer(train_texts, truncation=True, padding=True)
    train_dataset = Dataset(train_encodings, train_labels)

    test_texts, test_labels = read_csv('../.flair/datasets/amazon_review_full_csv/test.csv')
