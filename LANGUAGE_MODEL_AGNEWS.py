...
def train(model_checkpoint, run, samples, train_texts, train_labels, test_texts, test_labels):
    num_labels = 4
    if model_checkpoint == 'experiments_v2/0_bert_baseline/agnews/finetuned/bert/best_model':
        mod = "bert"
    elif model_checkpoint == 'experiments_v2/0_bert_baseline/agnews/finetuned/mnli_base/best_model':
        mod = "mnli_base"
    elif model_checkpoint == 'experiments_v2/0_bert_baseline/agnews/finetuned/mnli_adv/best_model':
        mod = "mnli_adv"
    else:
        mod = "unknown"
    ...
    with open(f"experiments_v2/0_bert_baseline/agnews/finetuned/{mod}-trained_on_{samples}-run_{run}.log", 'w') as f:
...
if __name__ == "__main__":
    model_checkpoints = ['experiments_v2/0_bert_baseline/agnews/finetuned/bert/best_model', 'experiments_v2/0_bert_baseline/agnews/finetuned/mnli_base/best_model', 'experiments_v2/0_bert_baseline/agnews/finetuned/mnli_adv/best_model']
